...
Assert-Quick ($en -match "npx skills add LightDevCoder/skills --yes --copy --agent '\*'" -and $en -match 'npx skills add LightDevCoder/skills --skill ask-light' -and $en -match '\$ask-light next' -and $en -match '\$project-init' -and $en -match '\$review-loop') "English Quick Start is missing a required command."
