...
Examples are documentation and validation assets. They never determine whether
a Skill is admissible, must not become a predefined canonical workflow, and
must not automatically invoke another user-invoked Skill.
...
T14 acceptance record; this documentation is not a substitute for that gate.
