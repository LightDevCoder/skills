...
- **Skill (`skills/engineering/agent-config`):** Installed from this repository ([LightDevCoder/skills](https://github.com/LightDevCoder/skills)). Performs task difficulty assessment, tier selection, and execution topology planning. Runs locally in the agent conversation.
