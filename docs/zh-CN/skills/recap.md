...
旧版 `recap` 已在 v0.1.2 中发布；本次仅手动触发的修订仍属于当前未发布候选。当前稳定发布版可使用 `npx skills add LightDevCoder/skills#v0.1.6 --skill recap --yes --copy --agent '*'` 安装，刷新 host，并在脱离 source checkout 的情况下确认 discovery；见[安装策略](../../INSTALLATION.zh-CN.md)。
