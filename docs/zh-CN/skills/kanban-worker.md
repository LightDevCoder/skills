...
行为权威是 [skills/project/kanban-worker/SKILL.md](../../../skills/project/kanban-worker/SKILL.md)；本页只说明如何调用，不复制第二份契约。
