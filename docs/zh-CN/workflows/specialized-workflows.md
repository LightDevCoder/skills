...
- [`manuscript-ops`](../../../skills/writing/manuscript-ops/SKILL.md) — 文稿工程状态机
- [`kb-init`](../../../skills/knowledge/kb-init/SKILL.md) — 经访谈设计、审批后实施的知识库
- [`learn-anything`](../../../skills/knowledge/learn-anything/SKILL.md) — 把有证据的来源提炼为可复用方法
- [`language-learning`](../../../skills/knowledge/language-learning/SKILL.md) — 六模式语言辅导
- [`kanban-worker`](../../../skills/project/kanban-worker/SKILL.md) — 每次唤醒一张任务的看板 worker
- [`recap`](../../../skills/productivity/recap/SKILL.md) — 一行总结（仅 `$recap`）
- [`eli5`](../../../skills/knowledge/eli5/SKILL.md) — 按受众水平解释
- [`release-workflow`](../../../skills/project/release-workflow/SKILL.md) — 验收后发布（也是主流程收尾）
...
| [`recap`](../../../skills/productivity/recap/SKILL.md) | `$recap` | 严格一行总结，不继续工作 | 停止 |
| [`eli5`](../../../skills/knowledge/eli5/SKILL.md) | 解释请求 | 按受众定制的解释 | 停止 |
| [`release-workflow`](../../../skills/project/release-workflow/SKILL.md) | `project-review PASS` 后 | 打 tag / GitHub Release / 同步文档 | 止于发布记录 |
