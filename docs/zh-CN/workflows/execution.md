...
- [`implement`](../../../skills/project/implement/SKILL.md) — user-invoked 通用有边界执行器
- [`agent-config`](../../../skills/engineering/agent-config/SKILL.md) — model-invoked Profile 驱动跨 Harness 执行配置器
- [`tdd`](../../../skills/engineering/tdd/SKILL.md) — model-invoked 测试驱动环
- [`diagnosing-bugs`](../../../skills/engineering/diagnosing-bugs/SKILL.md) — model-invoked 诊断环
- [`resolving-merge-conflicts`](../../../skills/engineering/resolving-merge-conflicts/SKILL.md) — model-invoked 合并冲突解决
...
- **Skill（`skills/engineering/agent-config`）：** 从本仓库（[LightDevCoder/skills](https://github.com/LightDevCoder/skills)）安装。负责任务难度评估、档位选择与执行拓扑规划，在 Agent 会话中纯策略运行。
...
- SPEC 已准入 → 先 [`project-tickets`](../../../skills/project/project-tickets/SKILL.md)。
- 项目已完成 → [`project-review`](../../../skills/review/project-review/SKILL.md) / [review-system](review-system.md)。
- 不知入口 → [`ask-light`](../../../skills/productivity/ask-light/SKILL.md)。
