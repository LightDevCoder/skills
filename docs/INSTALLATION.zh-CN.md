...
公开第一方集合当前稳定版本是 [v0.2.3](https://github.com/LightDevCoder/skills/releases/tag/v0.2.3)，发布于 `v0.2.3` tag（发布前规格见[发布清单](evidence/releases/v0.2.3/RELEASE_MANIFEST.zh-CN.md)，发布后验证事实见[发布收据](evidence/releases/v0.2.3/RELEASE_RECEIPT.zh-CN.md)）。它提供 **36 个已准入的第一方 Skill**，涵盖七大按职责划分的分类目录。`skills/<category>/<name>/` 内的包契约仍是行为权威；本页规定安装方法与验证记录。
...
历史版本（如 `#v0.2.2`、`#v0.2.1` 与 `#v0.2.0`）依然保留供复现：
