...
公开第一方集合当前稳定版本是 [v0.1.6](https://github.com/LightDevCoder/skills/releases/tag/v0.1.6)，发布自 commit `e8c3589031bbc1cb76d7f928761ce3f60ebea3e1`。`skills/<name>/` 内的包契约仍是行为权威；本页只规定安装和验证证据。
