...
| Package-Local Suites | `PASS` | `ask-light` (94), `project-retro` (12), `implement` (17), `review-loop` (17), `project-review` (20), `socratic` (16), `agent-config` (57), `integrated-workflow` (3) |
