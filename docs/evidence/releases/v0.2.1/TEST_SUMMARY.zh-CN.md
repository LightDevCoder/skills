...
| 套件 | 状态 | 详情 |
| --- | --- | --- |
| Pytest 集合套件 | `PASS` | 316 个测试通过，覆盖所有包与集合测试模块 |
...
| 单包测试套件 | `PASS` | `ask-light` (85), `project-retro` (12), `implement` (8), `review-loop` (7), `project-review` (15), `socratic` (11), `agent-config` (12) |
