...
| --- | --- | --- |
| Local Test Suite | `PASS` | 395 passed (394 passed, 1 skip: `test_layer1_deterministic_schemas_via_companion_ajv` without external companion repo); 32 unittest (268 assertions); compileall clean; git diff --check clean |
