...
- **Timestamp:** `2026-09-20T05:39:12Z`
- **Mode:** `mock-baseline`
- **Model Version:** `offline-deterministic`
- **Total Scenarios:** `36`
- **Overall Passed:** `36`
- **Overall Failed:** `0`
- **Overall Accuracy:** `100.0%`
- **ask-light Workflow Safety:** `22/22 (100.0%)`
- **ask-light Semantic Accuracy:** `N/A` (Evaluated: 0, Not Evaluated: 22, Passed: 0)
- **agent-config Config Correctness:** `14/14 (100.0%)`
- **agent-config Complexity Semantic Accuracy:** `N/A` (Evaluated: 0, Not Evaluated: 14)
- **agent-config Reasoning Semantic Accuracy:** `N/A` (Evaluated: 0, Not Evaluated: 14)
- **Duration:** `0.0s`
...
| AL-16 | Ambiguous user request with trade-offs | `RECOMMEND` | `implement` | N/A | N/A | Yes | PASS | NOT_EVALUATED | **PASS** |
| AL-17 | Complex architectural overhaul request | `RECOMMEND` | `implement` | N/A | N/A | Yes | PASS | NOT_EVALUATED | **PASS** |
| AL-18 | Clear status question negative case (no false ambiguity) | `EXPLAIN` | `None` | N/A | N/A | Yes | PASS | NOT_EVALUATED | **PASS** |
| AL-19 | Negative ambiguity case: unambiguous disjunction query | `RECOMMEND` | `implement` | N/A | N/A | Yes | PASS | NOT_EVALUATED | **PASS** |
| AL-20 | Negative escalation case: simple refactor task | `RECOMMEND` | `implement` | N/A | N/A | Yes | PASS | NOT_EVALUATED | **PASS** |
...
- **Material Ambiguity (p >= 0.65):** TP=0, FP=0, TN=0, FN=0 (Total evaluated: 0)
- **Reasoning Escalation (p >= 0.60):** TP=0, FP=0, TN=0, FN=0 (Total evaluated: 0)
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
| AC-01 | Routine documentation edit | `gpt-4o-mini` | `default` | `Case C` | PASS | NOT_EVALUATED | NOT_EVALUATED | **PASS** |
| AC-02 | Small bug fix | `claude-3-5-sonnet` | `default` | `Case A` | PASS | NOT_EVALUATED | NOT_EVALUATED | **PASS** |
| AC-03 | Standard feature implementation | `claude-3-5-sonnet` | `default` | `Case A` | PASS | NOT_EVALUATED | NOT_EVALUATED | **PASS** |
| AC-04 | Large refactor | `o3-mini` | `high` | `Case C` | PASS | NOT_EVALUATED | NOT_EVALUATED | **PASS** |
| AC-05 | Security-critical change | `o3-mini` | `high` | `Case C` | PASS | NOT_EVALUATED | NOT_EVALUATED | **PASS** |
| AC-06 | Complex concurrency work | `o3-mini` | `high` | `Case C` | PASS | NOT_EVALUATED | NOT_EVALUATED | **PASS** |
| AC-07 | Cost-sensitive complex work | `o3-mini` | `high` | `Case C` | PASS | NOT_EVALUATED | NOT_EVALUATED | **PASS** |
| AC-08 | Latency-sensitive routine work | `gpt-4o-mini` | `default` | `Case C` | PASS | NOT_EVALUATED | NOT_EVALUATED | **PASS** |
| AC-09 | Fixed-model harness | `fixed-sonnet` | `default` | `Case A` | PASS | NOT_EVALUATED | NOT_EVALUATED | **PASS** |
| AC-10 | Multi-model decomposed harness | `o3-mini` | `default` | `Case D` | PASS | NOT_EVALUATED | NOT_EVALUATED | **PASS** |
| AC-11 | Host with no effort selector | `gpt-4o` | `default` | `Case A` | PASS | NOT_EVALUATED | NOT_EVALUATED | **PASS** |
...
| AC-14 | User rejects configuration change preview | `active-stay` | `default` | `Case A` | PASS | NOT_EVALUATED | NOT_EVALUATED | **PASS** |
