...
> Local workspace tracker: inspect `.scratch/` for the active feature directory — see `docs/agents/issue-tracker.md`. This note is local-only and does not alter the maintenance contract below.
