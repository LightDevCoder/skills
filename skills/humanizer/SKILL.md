...
description: |
  ...
  or chatbot artifacts. Works for English and Chinese text (去除中英文文本中的
  AI 写作痕迹，使行文自然、更像人写). Based on Wikipedia's "Signs of AI writing."
---
...
Detect the language of the text to humanize before applying the patterns:

- **English text:** use the patterns below as written.
- **Chinese text:** read [references/zh-adaptation.md](references/zh-adaptation.md) first. It overrides the patterns that behave differently in Chinese (§14, §17, §19, §26), maps the others to their Chinese manifestations, and supplies the Chinese trigger vocabulary. The pattern numbers below still refer to the English statements.
- **Mixed text:** route each language span to its rule set.

The rewrite rules — keep every claim, never invent facts, match the voice — apply in every language.
