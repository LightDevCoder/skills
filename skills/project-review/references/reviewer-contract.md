...
This is the common, lightweight contract for a read-only reviewer used by
`project-review`. It is kept inside this package so a standalone install does
not depend on repository-level documentation.
