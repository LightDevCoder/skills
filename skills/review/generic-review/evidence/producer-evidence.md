...
- Package: `skills/review/generic-review`
...
```text
python3 -m unittest discover -s skills/review/generic-review/tests -p 'test_*.py' -v

Ran 14 tests in 0.006s
OK
```

`python3 -m compileall -q skills/review/generic-review` and `git diff --check` also
